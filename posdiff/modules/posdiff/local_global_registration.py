## modified from https://github.com/qinzheng93/GeoTransformer
...
from posdiff.modules.registration import WeightedProcrustes
...
class LocalGlobalRegistration(nn.Module):
    def __init__(
        ...
        """Point Matching with Local-Global Registration.
    ...
    def local_global_registration(self, ref_knn_points, src_knn_points, score_mat, corr_mat, src_points_f_corr, src_points_f_corr_ref):
        transfered_src_corr_points = src_points_f_corr
        ...
        for _ in range(self.num_refinement_steps - 1):
            ...
            transfered_src_corr_points = apply_transform(transfered_src_corr_points.unsqueeze(0), estimated_transform).squeeze(0)

        return global_ref_corr_points, global_src_corr_points, global_corr_scores, estimated_transform, transfered_src_corr_points
    ...
    def forward(
        ...
        ref_corr_points, src_corr_points, corr_scores, estimated_transform, transfered_src_corr_points = self.local_global_registration(
            ref_knn_points, src_knn_points, score_mat, corr_mat, src_points_f_corr, src_points_f_corr_ref,
        )

        return ref_corr_points, src_corr_points, corr_scores, estimated_transform, transfered_src_corr_points

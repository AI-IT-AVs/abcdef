from posdiff.modules.registration.matching import (
...
from posdiff.modules.registration.metrics import (
...
from posdiff.modules.registration.procrustes import weighted_procrustes, WeightedProcrustes

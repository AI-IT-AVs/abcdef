...
class PPMultiHeadAttention(nn.Module):
    def __init__(self, d_model, num_heads, dropout=None):
        super(PPMultiHeadAttention, self).__init__()
    ...
    def forward(self, input_q, input_k, input_v, embed_qk, key_weights=None, key_masks=None, attention_factors=None):
        ...
        p = rearrange(self.proj_p(embed_qk), 'b m (h c) -> b h m c', h=self.num_heads)
...
class PPAttentionLayer(nn.Module):
    def __init__(self, d_model, num_heads, dropout=None):
        super(PPAttentionLayer, self).__init__()
        self.attention = PPMultiHeadAttention(d_model, num_heads, dropout=dropout)
...
class PPTransformerLayer(nn.Module):
    def __init__(self, d_model, num_heads, dropout=None, activation_fn='ReLU'):
        super(PPTransformerLayer, self).__init__()
        self.attention = PPAttentionLayer(d_model, num_heads, dropout=dropout)

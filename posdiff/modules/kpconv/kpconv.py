...
from posdiff.modules.kpconv.kernel_points import load_kernels
...
class KPConv(nn.Module):
    def __init__(
        ...
        Modified from [KPConv-PyTorch](https://github.com/HuguesTHOMAS/KPConv-PyTorch) and [GeoTransformer](https://github.com/qinzheng93/GeoTransformer).

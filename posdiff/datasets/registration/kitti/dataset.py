...
class OdometryKittiPairDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        pointcloud_2 = getPointCloud(self.all_idx[index, 0], self.all_idx[index, 1], self.all_idx[index, 2], num_points=int(self.num_points / self.reserve) )
        pointcloud_1 = getPointCloud(self.all_idx[index, 0], self.all_idx[index, 2], self.all_idx[index, 1], num_points=int(self.num_points / self.reserve) )        
        ...
        data_dict['src_frame'] = self.all_idx[index, 2]

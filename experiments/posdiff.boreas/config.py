...
_C.log_dir = osp.join(_C.output_dir, 'log')
_C.event_dir = osp.join(_C.output_dir, 'event')
_C.feature_dir = osp.join(_C.output_dir, 'prediction')
...
_C.listTest_num=int(3) ##seq_3 : night
# _C.listTest_num=int(0) ##seq_0: snow
# _C.listTest_num=int(1) ##seq_1: rain
# _C.listTest_num=int(4) ##seq_4: sunny2 
